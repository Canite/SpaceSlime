...
/**
    ...
    Port to Java by Philip Diffenderfer http://magnos.org
 	...
 	This version has been altered by Austin Ross, 3/19/2017
 	Renamed from Mat2 to Matrix2, Vec2 substituted with Vector2 (libgdx)
*/
...
public class Matrix2 {
	...
	public Matrix2 abs()
	{
		return abs( new Matrix2() );
	}

	/**
	 * Sets out to the absolute value of this matrix.
	 */
	public Matrix2 abs( Matrix2 out )
	{
