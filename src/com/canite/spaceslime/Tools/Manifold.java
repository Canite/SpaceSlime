...
public class Manifold {
    ...
    public void initialize() {
        ...
        /*for (int i = 0; i < num_contacts; i++) {
            ...
            float resting_velocity = new Vector2(0.0f, 30.0f).scl(1.0f / Gdx.graphics.getFramesPerSecond()).len2() + 0.0001f;
    ...
    public void applyImpulse() {
        ...
        for (int i = 0; i < num_contacts; i++) {
            ...
            float contact_velocity = velocity.dot(normal);
            ...
            Vector2 impulse = normal.scl(impulse_scalar);
            ...
            if (Math.abs(tangent_scalar) < 0.001f) {
                return;
            }
            ...
            if (StrictMath.abs( tangent_scalar ) < impulse_scalar * stat_friction) {
                tangent_impulse = tangent.cpy().scl(tangent_scalar);
            }
            else {
                tangent_impulse = tangent.cpy().scl(-dyn_friction);
            }
